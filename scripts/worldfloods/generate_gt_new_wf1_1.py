...
from ml4floods.data.create_gt import generate_land_water_cloud_gt
...
def main():
        ...
        for i_file in pbar_files:
            ...
            try:
                ...
                if not GCPPath(s2_image_filepath).check_if_file_exists():
                    ...
                    # problem file
                    problem_files.append(s2_image_filepath)
                    continue
                ...
                if not GCPPath(jrc_image_filepath).check_if_file_exists():
                    ...
                    # problem file
                    problem_files.append(jrc_image_filepath)
                    continue
    ...
    with open("./problems_jrc_wf1.1.pickle", "wb") as fp:
