...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--image",
        required=True,
        help="Path to folder with tif files or tif file to make prediction",
    )
    parser.add_argument(
        "--model_path",
    ...
    parser.add_argument(
        "--th_water",
        help="Threshold water used in v2 models (multioutput binary)",
        type=float,
        default=0.5,
    )
    parser.add_argument(
        "--th_brightness",
        help="Threshold brightness used to get cloud predictions",
        type=float,
