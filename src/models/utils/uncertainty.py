...
def compute_uncertainties(dataloader, p_pred_fun, d_pred_fun, num_class, label_names, config, num_samples=10, plot=True):
    ...
    Args:
        ...
        focus_label: name of class we're interested in finding uncertainty around
        num_samples: number of samples to take from network to calculate uncertainty from
        plot: flag for calling plot method with uncertainty images
