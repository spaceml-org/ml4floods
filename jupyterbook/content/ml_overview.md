...
The ML4Ops section have tutorials for train, test and run inference of flood extent segmentation models for Sentinel-2. 
Models are trained in the *WorldFloods*[1] dataset which can be downloaded from `gs://ml4cc_data_lake/2_PROD/2_Mart/worldfloods_v1_0/`. 
